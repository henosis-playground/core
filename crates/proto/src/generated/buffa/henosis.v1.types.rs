...
impl ::core::fmt::Debug for NewComponentSpec {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("NewComponentSpec")
...
impl NewComponentSpec {
    ...
    ///
    /// Format: `type.googleapis.com/<fully.qualified.TypeName>`
    pub const TYPE_URL: &'static str = "type.googleapis.com/henosis.v1.NewComponentSpec";
}
impl NewComponentSpec {
    #[must_use = "with_* setters return `self` by value; assign or chain the result"]
    #[inline]
...
::buffa::impl_default_instance!(NewComponentSpec);
impl ::buffa::MessageName for NewComponentSpec {
    const PACKAGE: &'static str = "henosis.v1";
...
impl ::buffa::Message for NewComponentSpec {
    /// Returns the total encoded size in bytes.
    ///
    /// The result is a `u32`; the protobuf specification requires all
    /// messages to fit within 2 GiB (2,147,483,647 bytes), so a
...
impl ::buffa::ExtensionSet for NewComponentSpec {
    const PROTO_FQN: &'static str = "henosis.v1.NewComponentSpec";
    fn unknown_fields(&self) -> &::buffa::UnknownFields {
        &self.__buffa_unknown_fields
    }
    fn unknown_fields_mut(&mut self) -> &mut ::buffa::UnknownFields {
...
impl ::buffa::json_helpers::ProtoElemJson for NewComponentSpec {
    fn serialize_proto_json<S: ::serde::Serializer>(
        v: &Self,
        s: S,
    ) -> ::core::result::Result<S::Ok, S::Error> {
...
#[doc(hidden)]
pub const __NEW_COMPONENT_SPEC_JSON_ANY: ::buffa::type_registry::JsonAnyEntry = ::buffa::type_registry::JsonAnyEntry {
    type_url: "type.googleapis.com/henosis.v1.NewComponentSpec",
    to_json: ::buffa::type_registry::any_to_json::<NewComponentSpec>,
    from_json: ::buffa::type_registry::any_from_json::<NewComponentSpec>,
    is_wkt: false,
};
...
pub struct Component {
    ...
    pub time_created: ::buffa::MessageField<::buffa_types::google::protobuf::Timestamp>,
    ...
    pub time_modified: ::buffa::MessageField<::buffa_types::google::protobuf::Timestamp>,
    #[serde(skip)]
    #[doc(hidden)]
    pub __buffa_unknown_fields: ::buffa::UnknownFields,
}
...
impl ::buffa::Message for Component {
    ...
    fn merge_field(
        ...
        match tag.field_number() {
            ...
            4u32 => {
                ...
                ::buffa::Message::merge_length_delimited(
                    self.time_created.get_or_insert_default(),
                    buf,
                    ctx,
                )?;
            }
            5u32 => {
                ...
                ::buffa::Message::merge_length_delimited(
                    self.time_modified.get_or_insert_default(),
                    buf,
                    ctx,
                )?;
            }
    ...
    fn clear(&mut self) {
        ...
        self.time_created = ::buffa::MessageField::none();
        self.time_modified = ::buffa::MessageField::none();
        self.__buffa_unknown_fields.clear();
    }
}
