...
#[derive(Clone, Debug, Default)]
pub struct GetGraphGenerationRequestView<'a> {
    /// Field 1: `graph_id`
    pub graph_id: ::core::option::Option<&'a [u8]>,
    /// Field 2: `generation`
...
impl<'a> ::buffa::MessageView<'a> for GetGraphGenerationRequestView<'a> {
    type Owned = super::super::GetGraphGenerationRequest;
    fn decode_view(buf: &'a [u8]) -> ::core::result::Result<Self, ::buffa::DecodeError> {
        let __limit = ::core::cell::Cell::new(::buffa::DEFAULT_UNKNOWN_FIELD_LIMIT);
        <Self as ::buffa::MessageView>::decode_view_ctx(
            buf,
    ...
    fn to_owned_message(
        ...
        super::super::GetGraphGenerationRequest,
        ::buffa::DecodeError,
    > {
        self.to_owned_from_source(None)
    }
    ...
    > {
        ...
        use ::buffa::alloc::string::ToString as _;
        let _ = __buffa_src;
        ::core::result::Result::Ok(super::super::GetGraphGenerationRequest {
            graph_id: self.graph_id.map(|b| (b).to_vec()),
...
impl<'a> ::buffa::ViewEncode<'a> for GetGraphGenerationRequestView<'a> {
    #[allow(clippy::needless_borrow, clippy::let_and_return)]
    fn compute_size(&self, _cache: &mut ::buffa::SizeCache) -> u32 {
        #[allow(unused_imports)]
        use ::buffa::Enumeration as _;
...
/// known map lengths (e.g. `bincode`) will return a runtime error.
/// Use the owned message type for those formats.
impl<'__a> ::serde::Serialize for GetGraphGenerationRequestView<'__a> {
    fn serialize<__S: ::serde::Serializer>(
        &self,
        __s: __S,
    ) -> ::core::result::Result<__S::Ok, __S::Error> {
...
impl<'a> ::buffa::MessageName for GetGraphGenerationRequestView<'a> {
    const PACKAGE: &'static str = "henosis.v1";
...
::buffa::impl_default_view_instance!(GetGraphGenerationRequestView);
::buffa::impl_view_reborrow!(GetGraphGenerationRequestView);
/** Self-contained, `'static` owned view of a `GetGraphGenerationRequest` message.

 Wraps [`::buffa::OwnedView`]`<`[`GetGraphGenerationRequestView`]`<'static>>`: the decoded view and the [`::buffa::bytes::Bytes`] buffer it borrows from travel together, so the handle is `'static` and `Send + Sync` — suitable for async handlers, spawned tasks, and anywhere a `'static` bound is required.

 Field accessors return borrows tied to `&self`. Use [`Self::view`] to get the full [`GetGraphGenerationRequestView`] when you need struct patterns, iteration helpers, or to pass the view to lifetime-parameterised code.*/
#[derive(Clone, Debug)]
pub struct GetGraphGenerationRequestOwnedView(
    ::buffa::OwnedView<GetGraphGenerationRequestView<'static>>,
);
impl GetGraphGenerationRequestOwnedView {
    /// Decode an owned view from a [`::buffa::bytes::Bytes`] buffer.
    ///
    /// The view borrows directly from the buffer's data; the buffer is
    /// retained inside the returned handle.
    ...
    pub fn decode(
        ...
        ::core::result::Result::Ok(
            GetGraphGenerationRequestOwnedView(::buffa::OwnedView::decode(bytes)?),
        )
    }
    /// Decode with custom [`::buffa::DecodeOptions`] (recursion limit,
    /// max message size).
    ...
    pub fn decode_with_options(
        ...
        ::core::result::Result::Ok(
            GetGraphGenerationRequestOwnedView(
                ::buffa::OwnedView::decode_with_options(bytes, opts)?,
            ),
        )
    }
    ...
    /// somehow invalid (should not happen for well-formed messages).
    pub fn from_owned(
        msg: &super::super::GetGraphGenerationRequest,
    ) -> ::core::result::Result<Self, ::buffa::DecodeError> {
        ::core::result::Result::Ok(
            GetGraphGenerationRequestOwnedView(::buffa::OwnedView::from_owned(msg)?),
        )
    }
    /// Borrow the full [`GetGraphGenerationRequestView`] with its lifetime tied to `&self`.
    #[must_use]
    pub fn view(&self) -> &GetGraphGenerationRequestView<'_> {
        self.0.reborrow()
    }
    /// Convert to the owned message type.
    ///
...
impl ::core::convert::From<::buffa::OwnedView<GetGraphGenerationRequestView<'static>>>
for GetGraphGenerationRequestOwnedView {
    fn from(inner: ::buffa::OwnedView<GetGraphGenerationRequestView<'static>>) -> Self {
        GetGraphGenerationRequestOwnedView(inner)
    }
}
impl ::core::convert::From<GetGraphGenerationRequestOwnedView>
for ::buffa::OwnedView<GetGraphGenerationRequestView<'static>> {
    fn from(wrapper: GetGraphGenerationRequestOwnedView) -> Self {
        wrapper.0
    }
}
impl ::core::convert::AsRef<::buffa::OwnedView<GetGraphGenerationRequestView<'static>>>
for GetGraphGenerationRequestOwnedView {
    fn as_ref(&self) -> &::buffa::OwnedView<GetGraphGenerationRequestView<'static>> {
        &self.0
    }
}
impl ::buffa::HasMessageView for super::super::GetGraphGenerationRequest {
    type View<'a> = GetGraphGenerationRequestView<'a>;
    type ViewHandle = GetGraphGenerationRequestOwnedView;
}
impl ::serde::Serialize for GetGraphGenerationRequestOwnedView {
    fn serialize<__S: ::serde::Serializer>(
        &self,
        __s: __S,
    ) -> ::core::result::Result<__S::Ok, __S::Error> {
...
#[derive(Clone, Debug, Default)]
pub struct GetGraphGenerationResponseView<'a> {
    /// Field 1: `state`
    pub state: ::buffa::MessageFieldView<
        super::super::__buffa::view::GraphStateView<'a>,
    >,
...
impl<'a> ::buffa::MessageView<'a> for GetGraphGenerationResponseView<'a> {
    type Owned = super::super::GetGraphGenerationResponse;
    fn decode_view(buf: &'a [u8]) -> ::core::result::Result<Self, ::buffa::DecodeError> {
        let __limit = ::core::cell::Cell::new(::buffa::DEFAULT_UNKNOWN_FIELD_LIMIT);
        <Self as ::buffa::MessageView>::decode_view_ctx(
            buf,
    ...
    fn merge_view_field(
        ...
        match tag.field_number() {
            ...
            4u32 => {
                ...
                view.last_published_generation = Some(
                    ::buffa::types::decode_uint64(&mut cur)?,
                );
            }
            2u32 => {
    ...
    fn to_owned_message(
        ...
        super::super::GetGraphGenerationResponse,
        ::buffa::DecodeError,
    > {
        self.to_owned_from_source(None)
    }
    ...
    > {
        ...
        use ::buffa::alloc::string::ToString as _;
        let _ = __buffa_src;
        ::core::result::Result::Ok(super::super::GetGraphGenerationResponse {
            state: match self.state.as_option() {
                Some(v) => {
                    ::buffa::MessageField::<
                        super::super::GraphState,
...
impl<'a> ::buffa::ViewEncode<'a> for GetGraphGenerationResponseView<'a> {
    #[allow(clippy::needless_borrow, clippy::let_and_return)]
    fn compute_size(&self, __cache: &mut ::buffa::SizeCache) -> u32 {
        #[allow(unused_imports)]
        use ::buffa::Enumeration as _;
...
/// known map lengths (e.g. `bincode`) will return a runtime error.
/// Use the owned message type for those formats.
impl<'__a> ::serde::Serialize for GetGraphGenerationResponseView<'__a> {
    fn serialize<__S: ::serde::Serializer>(
        &self,
        __s: __S,
    ) -> ::core::result::Result<__S::Ok, __S::Error> {
        ...
        if let ::core::option::Option::Some(ref __v) = self.current_lifecycle {
            __map.serialize_entry("currentLifecycle", __v)?;
        }
        if let ::core::option::Option::Some(__v) = self.last_published_generation {
            __map
                .serialize_entry(
...
impl<'a> ::buffa::MessageName for GetGraphGenerationResponseView<'a> {
    const PACKAGE: &'static str = "henosis.v1";
...
::buffa::impl_default_view_instance!(GetGraphGenerationResponseView);
::buffa::impl_view_reborrow!(GetGraphGenerationResponseView);
/** Self-contained, `'static` owned view of a `GetGraphGenerationResponse` message.

 Wraps [`::buffa::OwnedView`]`<`[`GetGraphGenerationResponseView`]`<'static>>`: the decoded view and the [`::buffa::bytes::Bytes`] buffer it borrows from travel together, so the handle is `'static` and `Send + Sync` — suitable for async handlers, spawned tasks, and anywhere a `'static` bound is required.

 Field accessors return borrows tied to `&self`. Use [`Self::view`] to get the full [`GetGraphGenerationResponseView`] when you need struct patterns, iteration helpers, or to pass the view to lifetime-parameterised code.*/
#[derive(Clone, Debug)]
pub struct GetGraphGenerationResponseOwnedView(
    ::buffa::OwnedView<GetGraphGenerationResponseView<'static>>,
);
impl GetGraphGenerationResponseOwnedView {
    /// Decode an owned view from a [`::buffa::bytes::Bytes`] buffer.
    ///
    /// The view borrows directly from the buffer's data; the buffer is
    /// retained inside the returned handle.
    ...
    pub fn decode(
        ...
        ::core::result::Result::Ok(
            GetGraphGenerationResponseOwnedView(::buffa::OwnedView::decode(bytes)?),
        )
    }
    /// Decode with custom [`::buffa::DecodeOptions`] (recursion limit,
    /// max message size).
    ...
    pub fn decode_with_options(
        ...
        ::core::result::Result::Ok(
            GetGraphGenerationResponseOwnedView(
                ::buffa::OwnedView::decode_with_options(bytes, opts)?,
            ),
        )
    }
    ...
    /// somehow invalid (should not happen for well-formed messages).
    pub fn from_owned(
        msg: &super::super::GetGraphGenerationResponse,
    ) -> ::core::result::Result<Self, ::buffa::DecodeError> {
        ::core::result::Result::Ok(
            GetGraphGenerationResponseOwnedView(::buffa::OwnedView::from_owned(msg)?),
        )
    }
    /// Borrow the full [`GetGraphGenerationResponseView`] with its lifetime tied to `&self`.
    #[must_use]
    pub fn view(&self) -> &GetGraphGenerationResponseView<'_> {
        self.0.reborrow()
    }
    /// Convert to the owned message type.
    ///
    ...
    pub fn current_lifecycle(
        ...
        self.0.reborrow().current_lifecycle
    }
    /// Field 4: `last_published_generation`
    #[must_use]
    pub fn last_published_generation(&self) -> ::core::option::Option<u64> {
        self.0.reborrow().last_published_generation
    }
}
impl ::core::convert::From<::buffa::OwnedView<GetGraphGenerationResponseView<'static>>>
for GetGraphGenerationResponseOwnedView {
    fn from(inner: ::buffa::OwnedView<GetGraphGenerationResponseView<'static>>) -> Self {
        GetGraphGenerationResponseOwnedView(inner)
    }
}
impl ::core::convert::From<GetGraphGenerationResponseOwnedView>
for ::buffa::OwnedView<GetGraphGenerationResponseView<'static>> {
    fn from(wrapper: GetGraphGenerationResponseOwnedView) -> Self {
        wrapper.0
    }
}
impl ::core::convert::AsRef<::buffa::OwnedView<GetGraphGenerationResponseView<'static>>>
for GetGraphGenerationResponseOwnedView {
    fn as_ref(&self) -> &::buffa::OwnedView<GetGraphGenerationResponseView<'static>> {
        &self.0
    }
}
impl ::buffa::HasMessageView for super::super::GetGraphGenerationResponse {
    type View<'a> = GetGraphGenerationResponseView<'a>;
    type ViewHandle = GetGraphGenerationResponseOwnedView;
}
impl ::serde::Serialize for GetGraphGenerationResponseOwnedView {
    fn serialize<__S: ::serde::Serializer>(
        &self,
        __s: __S,
    ) -> ::core::result::Result<__S::Ok, __S::Error> {
